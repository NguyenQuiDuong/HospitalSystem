...
<%
	...
	Employee currentEmp = (Employee) session.getAttribute("employee");List<Employee> employees = adminDAO.getListEmployeeWithout(currentEmp.getEmployeeId());
								...
								<div class="col-sm-3 ">
									<div class="form-group">
										...
										<c:if test="${not empty param['sucess']}">
											<script> demo.showNotification('top', 'right', 'User name or passsword error','danger') </script>
										</c:if>
									</div>
								</div>
