                           ...
                           <div class="form-group">
                              <div id="sandbox-container">
                                 ...
                                 <div class="input-daterange input-group" id="datepicker">
                                    <input class="form-control" name="startDate" type="text" required 	value="<%=FormateDate.getStringDate(selectedDrug.getStartDate())%>"
                        ...
                        <div class="col-sm-3 ">
                           <div class="form-group">
                              <div id="sandbox-container">
                                 ...
                                 <div class="input-daterange input-group" id="datepicker">
                                    <input class="form-control" name="drug_expired" type="text" required value="<%=FormateDate.getStringDate(selectedDrug.getDrug_expired())%>"
                                       placeholder="00/00/0000" readonly>
                                    <!-- 	<span class="input-group-addon"></span> -->
                                 </div>
                              </div>
